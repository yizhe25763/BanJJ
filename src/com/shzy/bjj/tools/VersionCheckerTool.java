 ...
 * @brief 共通机能-版本检测/更新
 * @author Fanhao.Yi
 * @date 2015年5月14日下午5:50:12
 * @version V1.0
 */
public class VersionCheckerTool {

	public static final String SERVER_VERSION = "version";
	public static final String CHANGE_LOG = "changeLog";
	public static final String APK_URL = "apkURL";
	public final static String SD_FOLDER = FileTool.gainSDCardPath()
			+ "/VersionChecker/";
	private static VersionCheckerTool mChecker = new VersionCheckerTool();
	private static final String TAG = VersionCheckerTool.class.getSimpleName();
...
//		HttpTool.get(strURL, new JsonHttpResponseHandler() {
//
//			@Override
//			public void onSuccess(int statusCode, Header[] headers,
//					final JSONObject response) {
//				if (getLocalVersion(mContext) >= response.optDouble(
//						SERVER_VERSION, 0.0)) {
//					AlertTool.toastShort(mContext, "已是最新版本");
//				} else {
//					AlertTool.dialog(mContext, "版本升级", "检测到有新版本，是否马上更新？",
	...
	private File downloadFile(String path, ProgressDialog pd) throws Exception {
		...
		if (Environment.MEDIA_MOUNTED.equals(Environment
			...
			String fileName = SD_FOLDER
					+ DateTimeTool.formatDateTime(new java.util.Date(),
							"yyyyMMddHHmm") + ".apk";
