...
import com.shzy.bjj.tools.image.BitmapCache.ImageCallback;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (selectedDataList.contains(dataList.get(position))) {
			...
			viewHolder.choosetoggle
					.setBackgroundResource(R.drawable.plugin_camera_choosed);
		} else {
			 viewHolder.toggleButton.setChecked(false);
			viewHolder.choosetoggle
					.setBackgroundResource(R.drawable.plugin_camera_no_choosed);
