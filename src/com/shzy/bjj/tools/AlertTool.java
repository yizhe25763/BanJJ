...
import com.shzy.bjj.bean.NotificationMessage;
import com.shzy.bjj.view.ProgressDialog;

/**
 * 
 * @brief 对话框工具类
 * @author Fanhao.Yi
 * @date 2015年4月24日上午10:58:54
 * @version V1.0
 */
...
public class AlertTool{
	...
	public static void toastShort(String msg) {
		Toast.makeText(MyApplication.gainContext(), msg, Toast.LENGTH_SHORT)
				.show();
	}
	...
	public static void toastLong(String msg) {
		Toast.makeText(MyApplication.gainContext(), msg, Toast.LENGTH_LONG)
				.show();
	}
	...
	public static void notification(Context mContext,
		...
		mIntent.setAction(StringTool.gainUUID());
