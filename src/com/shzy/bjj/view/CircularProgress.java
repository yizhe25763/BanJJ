...
public class CircularProgress extends View {
	...
	public CircularProgress(Context context, AttributeSet attrs,
		...
		a.recycle();
		mColors = new int[4];
		mColors[0] = context.getResources().getColor(R.color.progress_bg);
		mColors[1] = context.getResources().getColor(R.color.progress_bg);
		mColors[2] = context.getResources().getColor(R.color.progress_bg);
		mColors[3] = context.getResources().getColor(R.color.progress_bg);
