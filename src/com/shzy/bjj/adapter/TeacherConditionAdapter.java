 ...
 * 教师列表，选择条件
 */
public class TeacherConditionAdapter extends BaseAdapter {
	...
	public TeacherConditionAdapter() {
	}

	public TeacherConditionAdapter(int flag, Context context) {
		this.tag = flag;
	...
	public View getView(int position, View contentView, ViewGroup arg2) {
		...
		if (tag == 0) {
			...
			holder.idTextView.setText(mapBean.getTitle());
